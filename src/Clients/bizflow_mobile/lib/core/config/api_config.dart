...
class ApiConfig {
  ...
  // --- Nhóm Product ---
  static const String products = "$_productBaseUrl/api/Products";

  // --- Nhóm Order & Customer ---
  static const String customers = "$_orderBaseUrl/api/Customers";
  static const String payDebt = "$customers/pay-debt"; // API Thanh toán nợ
  static const String orders = "$_orderBaseUrl/api/Orders";
