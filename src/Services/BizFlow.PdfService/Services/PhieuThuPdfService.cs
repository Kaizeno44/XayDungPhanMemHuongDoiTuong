...
{
    public class PhieuThuPdfService : IPhieuThuPdfService
    {
        public byte[] GeneratePhieuThuPdf(PhieuThuData data)
        {
            try
            {
                ...
                return Document.Create(container =>
                {
                    container.Page(page =>
                    {
                        ...
                        // Thiết lập font chữ mặc định - Sử dụng Times New Roman theo yêu cầu
            ...
            {
                Console.WriteLine($"[PDF_ERROR] Lỗi khi tạo PDF: {ex.Message}");
                Console.WriteLine($"[PDF_ERROR] StackTrace: {ex.StackTrace}");
                throw;
            }
        }
    }
